...
- [session-scratch-adapters.md](session-scratch-adapters.md) — platform-neutral session scratch cleanup core, adapter protocol, safety invariants, and initial Claude/Pi behavior.
