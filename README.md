...
- **Subagents** — `reviewer`, `senior-engineer`, `refactorer`, `debugger`, `security-auditor`, `test-writer`, `product-manager`, `tech-writer`, `performance-tuner` — see [docs/catalog.md](docs/catalog.md).
