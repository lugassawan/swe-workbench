...
> **Applies:** SOLID principles — SRP, OCP, LSP, ISP, DIP (single responsibility, open-closed, Liskov substitution, interface segregation, dependency inversion).
...
> See `rules/principle-solid/examples/` for a worked DIP + OCP payment-gateway implementation in C#, Go, Java, Kotlin,
