...
> **Applies:** Clean Architecture, hexagonal architecture, ports and adapters, dependency rule, and domain-centric layering.
...
> See `rules/principle-clean-architecture/examples/` for worked MVC implementations in C#, Go, Java, Kotlin, Python, Ruby, Rust, Swift, and TypeScript (read on demand — not auto-loaded).
